...
public:
    ...
    void wait_until_empty(){
        __TBB_STATIC_ASSERT(internal::check_the_assert_message<T>::value, "task_arena::wait_util_empty() is removed, consider combine task_arena and task_group to achieve functionality similar to wait_until_empty");
    }
