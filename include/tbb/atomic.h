...
template<class T, class flagtype = internal::bool_constant<internal::is_atomic_compatiable<T>::value ||internal::aligned_storage<T, sizeof(T)>::value> >
...
template<class T>
struct atomic<T,internal::false_type>
{
  __TBB_STATIC_ASSERT(internal::check_the_assert_message<T>::value, __TBB_ASSERT_MSG_NOT_SUPPORT_ATOMIC_TYPE);
};
