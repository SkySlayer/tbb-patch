...
typename internal::enable_if<internal::is_copyable_class<Body>::value && internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body ) {
    internal::start_for<Range,Body,const __TBB_DEFAULT_PARTITIONER>::run(range,body,__TBB_DEFAULT_PARTITIONER());
}
template<typename Range, typename Body>
typename internal::enable_if<!internal::is_copyable_class<Body>::value && internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body ) {
  __TBB_STATIC_ASSERT(internal::check_the_assert_message<Body>::value, __TBB_ASSERT_MSG_PARALLEL_FOR_BODY_SHOULD_BE_COPYABLE);
}

template<typename Range, typename Body>
typename internal::enable_if<!internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body ) {
  __TBB_STATIC_ASSERT(internal::check_the_assert_message<Body>::value, __TBB_ASSERT_MSG_PARALLEL_FOR_BODY_SHOULD_HAVE_CONST_OPERATOR);
}
//! Parallel iteration over range with simple partitioner.
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value&& internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body, const simple_partitioner& partitioner ) {
...
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value && internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body, const auto_partitioner& partitioner ) {
...
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value && internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body, affinity_partitioner& partitioner ) {
    internal::start_for<Range,Body,affinity_partitioner>::run(range,body,partitioner);
}
template<typename Range, typename Body, typename Partitioner>
typename internal::enable_if<!internal::is_copyable_class<Body>::value && internal::is_operator_const<Body>::value, void>::type parallel_for(const Range& range, const Body& body, const Partitioner & p ) {
  __TBB_STATIC_ASSERT(internal::check_the_assert_message<Body>::value, __TBB_ASSERT_MSG_PARALLEL_FOR_BODY_SHOULD_BE_COPYABLE);
}
template<typename Range, typename Body, typename Partitioner>
typename internal::enable_if<!internal::is_operator_const<Body>::value, void>::type parallel_for( const Range& range, const Body& body, const Partitioner & p ) {
  __TBB_STATIC_ASSERT(internal::check_the_assert_message<Body>::value, __TBB_ASSERT_MSG_PARALLEL_FOR_BODY_SHOULD_HAVE_CONST_OPERATOR);
}
...
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value, void>::type parallel_for( const Range& range, const Body& body, task_group_context& context ) {
...
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value, void>::type parallel_for( const Range& range, const Body& body, const simple_partitioner& partitioner, task_group_context& context ) {
...
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value, void>::type parallel_for( const Range& range, const Body& body, const auto_partitioner& partitioner, task_group_context& context ) {
...
/** @ingroup algorithms **/
template<typename Range, typename Body>
typename internal::enable_if<internal::is_copyable_class<Body>::value, void>::type parallel_for( const Range& range, const Body& body, affinity_partitioner& partitioner, task_group_context& context ) {
